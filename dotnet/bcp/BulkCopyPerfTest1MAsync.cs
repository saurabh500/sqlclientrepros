...
public class BulkCopyPerfTest1MAsync
{
    public static async Task Main(string[] args)
    {
        Console.WriteLine("==============================================");
        Console.WriteLine("C# Bulk Copy Performance Test - 1 Million Rows (ASYNC)");
        Console.WriteLine("==============================================\n");
        ...
        await using (SqlConnection connection = new SqlConnection(connectionString))
        {
            ...
            // Verify count
            await using (SqlCommand countCmd = new SqlCommand("SELECT COUNT(*) FROM #PerfTest", connection))
            {
                int actualCount = (int)(await countCmd.ExecuteScalarAsync())!;
            ...
            // Drop temp table
            await using (SqlCommand dropCmd = new SqlCommand("DROP TABLE #PerfTest", connection))
            {
        ...
        Console.WriteLine("==============================================");
        Console.WriteLine("ASYNC Performance Test Complete");
        Console.WriteLine("==============================================");
    }
}
